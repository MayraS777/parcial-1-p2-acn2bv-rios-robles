...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $tel = trim($_POST["tel"] ?? "");
    $consulta = trim($_POST["text"] ?? "");

    if ($nombre !== "" && $email !== "" && $consulta !== "") {
        $mensaje = "<p class='alert alert-success text-center'>¡Gracias $nombre! Tu consulta fue enviada correctamente.</p>";
    } else {
        $mensaje = "<p class='alert alert-danger text-center'>Por favor, completá los campos obligatorios.</p>";
    }
}
